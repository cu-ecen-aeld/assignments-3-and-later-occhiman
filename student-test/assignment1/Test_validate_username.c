...
void test_validate_my_username()
{
     ...
     */
    char *myUser;
    const char *myUserTest;

    myUserTest = my_username();
    myUser = malloc_username_from_conf_file();
    //TEST_ASSERT_TRUE_MESSAGE(false,"AESD students, please fix me!");
    TEST_ASSERT_TRUE_MESSAGE(*myUser == *myUserTest, "Git user configured is not the same!");
}
